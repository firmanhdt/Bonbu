...
<div class="max-w-xl mx-auto py-10 px-4">
    <h1 class="text-xl font-bold mb-4">Change Profile</h1>
    <form class="border rounded-lg bg-white p-6">
        <div class="mb-4">
        <label class="block font-semibold mb-1">Full Name</label>
        <input type="text" class="w-full border rounded px-3 py-2" placeholder="Ex : zzzxxsaa">
        </div>
        <div class="mb-4">
        ...
        <input type="email" class="w-full border rounded px-3 py-2" placeholder="Ex : zzzxxsaa">
        </div>
