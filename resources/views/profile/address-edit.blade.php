...
<h1 class="text-xl font-bold mb-4">Change Adress</h1>
<form class="border rounded-lg bg-white p-6 flex flex-col md:flex-row gap-6">
    ...
    <button type="submit" class="w-full border rounded py-2 font-semibold bg-white hover:bg-gray-100">Save Changes</button>
    </div>
</form>
</div> 
</x-app-layout>